...
![ADK abstracts away the complexity of Live API communication](https://github.com/kazunori279/adk-streaming-guide/blob/main/workshops/assets/bidi_plumbing.webp?raw=true)
...
![Raw Live API vs. ADK Gemini Live API Toolkit](https://github.com/kazunori279/adk-streaming-guide/blob/main/workshops/assets/live_vs_adk.png?raw=true)
...
![ADK Gemini Live API Toolkit Demo](https://github.com/kazunori279/adk-streaming-guide/blob/main/docs/assets/bidi-demo-screen.png?raw=true)
...
![](https://github.com/kazunori279/adk-streaming-guide/blob/main/workshops/assets/cloud_shell_editor.png?raw=true)

**Step 2: Download Workshop Files**

Open a New Terminal (**Terminal** → **New Terminal**):

![Open New Terminal](https://github.com/kazunori279/adk-streaming-guide/blob/main/workshops/assets/new_terminal.png?raw=true)
...
![Refresh Explorer button](https://github.com/kazunori279/adk-streaming-guide/blob/main/workshops/assets/refresh_explorer.png?raw=true)
...
![High-Level Architecture of ADK Gemini Live API Toolkit](https://github.com/kazunori279/adk-streaming-guide/blob/main/workshops/assets/Bidi_arch.jpeg?raw=true)
...
![Web Preview button](https://github.com/kazunori279/adk-streaming-guide/blob/main/workshops/assets/web_preview.png?raw=true)
...
![Connected](https://github.com/kazunori279/adk-streaming-guide/blob/main/workshops/assets/connected.png?raw=true)
...
![Echo: hello](https://github.com/kazunori279/adk-streaming-guide/blob/main/workshops/assets/echo_hello.png?raw=true)
...
![Live API models](https://github.com/kazunori279/adk-streaming-guide/blob/main/workshops/assets/vertex_ai_live_models.png?raw=true)
...
![4-Phase Application Lifecycle](https://github.com/kazunori279/adk-streaming-guide/blob/main/workshops/assets/app_lifecycle.png?raw=true)
...
![RunConfig Configuration Options](https://github.com/kazunori279/adk-streaming-guide/blob/main/workshops/assets/runconfig.png?raw=true)
...
![LiveRequestQueue Methods](https://github.com/kazunori279/adk-streaming-guide/blob/main/workshops/assets/live_req_queue.png?raw=true)
...
![Interrupt](https://github.com/kazunori279/adk-streaming-guide/blob/main/workshops/assets/interrupt.png?raw=true)
...
![Comprehensive Summary of ADK Live Event Handling](https://github.com/kazunori279/adk-streaming-guide/blob/main/workshops/assets/run_live.png?raw=true)
...
![Comprehensive Summary of ADK Live API Multimodal Capabilities](https://github.com/kazunori279/adk-streaming-guide/blob/main/workshops/assets/multimodal.png?raw=true)
