# ADK Gemini Live API Toolkit ワークショップ: リアルタイム音声AIを作ろう
...
ADK Gemini Live API Toolkitが管理するもの：
...
![生のLive API vs. ADK Gemini Live API Toolkit](https://raw.githubusercontent.com/kazunori279/adk-streaming-guide/refs/heads/main/workshops/assets/live_vs_adk.png)

| 機能 | 生のLive API | ADK Gemini Live API Toolkit |
|------|--------------|-------------------|
...
**Shopper's Concierge 2 デモ**: ADK Gemini Live API Toolkitと[Vertex AI](https://cloud.google.com/vertex-ai) Vector Search、Embeddings、Feature Store、Ranking APIで構築された、Eコマース向けリアルタイムAgentic RAGデモ：
...
包括的な詳細については、[ADK Gemini Live API Toolkit開発者ガイド](https://google.github.io/adk-docs/streaming/dev-guide/part1/)をご覧ください—アーキテクチャから本番デプロイまでをカバーする5部構成のシリーズです：
...
![ADK Gemini Live API Toolkit デモ](https://raw.githubusercontent.com/kazunori279/adk-streaming-guide/refs/heads/main/docs/assets/bidi-demo-screen.png)
...
- [課金が有効](https://cloud.google.com/billing/docs/how-to/modify-project)な[Google Cloudプロジェクト](https://developers.google.com/workspace/guides/create-project)
...
![ADK Gemini Live API Toolkitの高レベルアーキテクチャ](https://raw.githubusercontent.com/kazunori279/adk-streaming-guide/refs/heads/main/workshops/assets/Bidi_arch.jpeg)
...
>
> **より詳しい解説**: [ADK Gemini Live API Toolkitアーキテクチャ](https://google.github.io/adk-docs/streaming/dev-guide/part1/)
...
このワークショップでは、ADK Gemini Live API Toolkitを利用して双方向ストリーミングAIアプリケーションをゼロから構築しました。このアプリケーションはリアルタイムストリーミング応答でテキスト、音声、画像入力を処理します—本番環境対応の会話型AIを構築するための基盤です。
...
これらの公式リソースで学習を続けてください。ADK Gemini Live API Toolkitガイドはこのワークショップのすべてをより深くカバーしています。

| リソース | URL |
|----------|-----|
| ADKドキュメント | https://google.github.io/adk-docs/ |
| ADK Gemini Live API Toolkitガイド | https://google.github.io/adk-docs/streaming/dev-guide/ |
